...
# v4 stronger green overrides for Streamlit/BaseWeb widgets
...
input[type="range"]::-moz-range-track {
  background: rgba(27,127,90,0.18) !important;
}

/* Slider Streamlit / BaseWeb: forzatura completa verde */
...
/* Radio button verdi */
div[role="radiogroup"] [data-baseweb="radio"] input,
...
.stTabs [data-testid="stDecoration"] {
  background: rgba(27,127,90,0.22) !important;
}

/* Forzatura finale anti-rosso Streamlit/BaseWeb */
:root,
.stApp,
...
[data-testid="stHeader"] {
  --primary-color: var(--accent) !important;
  --primary-color-rgb: 27,127,90 !important;
}

/* Qualsiasi inline style rosso residuo nei controlli principali */
[data-baseweb="slider"] *[style*="#ff4b4b"],
[data-baseweb="slider"] *[style*="#FF4B4B"],
[data-baseweb="slider"] *[style*="rgb(255, 75, 75)"],
[data-baseweb="slider"] *[style*="rgb(255,75,75)"],
[data-baseweb="slider"] *[fill="#ff4b4b"],
[data-baseweb="slider"] *[stroke="#ff4b4b"],
[data-baseweb="slider"] *[fill="#FF4B4B"],
[data-baseweb="slider"] *[stroke="#FF4B4B"],
div[role="radiogroup"] *[style*="#ff4b4b"],
div[role="radiogroup"] *[style*="#FF4B4B"],
div[role="radiogroup"] *[style*="rgb(255, 75, 75)"],
div[role="radiogroup"] *[style*="rgb(255,75,75)"],
div[role="radiogroup"] *[fill="#ff4b4b"],
div[role="radiogroup"] *[stroke="#ff4b4b"],
div[role="radiogroup"] *[fill="#FF4B4B"],
div[role="radiogroup"] *[stroke="#FF4B4B"],
.stTabs *[style*="#ff4b4b"],
.stTabs *[style*="#FF4B4B"],
.stTabs *[style*="rgb(255, 75, 75)"],
.stTabs *[style*="rgb(255,75,75)"],
.stTabs *[fill="#ff4b4b"],
.stTabs *[stroke="#ff4b4b"],
.stTabs *[fill="#FF4B4B"],
.stTabs *[stroke="#FF4B4B"] {
  background: var(--accent) !important;
...
/* Slider: bolla/etichetta valore e segmenti */
...
/* Radio: cerchi selezionati/deselezionati */
div[role="radiogroup"] label,
div[role="radiogroup"] [data-baseweb="radio"] {
  color: var(--text) !important;
}
div[role="radiogroup"] label svg circle,
div[role="radiogroup"] [data-baseweb="radio"] svg circle {
  stroke: var(--accent) !important;
}
div[role="radiogroup"] label:has(input:checked) svg circle:last-child,
div[role="radiogroup"] [data-baseweb="radio"]:has(input:checked) svg circle:last-child {
  fill: var(--accent) !important;
  stroke: var(--accent) !important;
}
div[role="radiogroup"] label:has(input:not(:checked)) svg circle:last-child,
div[role="radiogroup"] [data-baseweb="radio"]:has(input:not(:checked)) svg circle:last-child {
  fill: transparent !important;
}

/* Tab underline / mini barra */
.stTabs [data-baseweb="tab-highlight"],
.stTabs [data-baseweb="tab-highlight"]::before,
...
DAPSS_DEFAULT = {
    ...
    430: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI", 437: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI",
    429: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI", 503: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI",
    570: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI", 585: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI",
    893: "SERVIZI DIAGNOSTICI - AMBULATORIALI - RIABILITATIVI",
    ...
    402: "AREA MATERNO-INFANTILE", 403: "AREA MATERNO-INFANTILE", 210: "AREA MATERNO-INFANTILE",
    400: "AREA MATERNO-INFANTILE",
...
with tab2:
    ...
    style_green(fig1); fig1.update_layout(xaxis_tickangle=45, yaxis_title="%")
    ...
    style_green(fig2); fig2.update_layout(xaxis_tickangle=45, yaxis_title="FTE")
